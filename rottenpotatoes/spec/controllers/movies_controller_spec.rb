...
describe MoviesController do
  before(:each) do
    @movie1 = Movie.create!(title: 'No title', rating: 'PG', description: 'No description', release_date:'2020-01-01')
    @movie2 = Movie.create!(title: 'No title', rating: 'PG', description: 'No description', release_date:'2020-01-01')
    @movie3 = Movie.create!(title: 'No title', rating: 'PG', description: 'No description', release_date:'2020-01-01')
  end
  ...
  describe 'PUT #update' do
    ...
    before(:each) do
      put :update, id: @movie1.id, :movie => mod_attr
    end
